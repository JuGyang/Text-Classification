...
def seg_doc(str_doc):
    ...
    sent_list = map(textParse_content, sent_list)  # 正则处理，去掉一些字符，例如\u3000
...
# 创建停用词列表
def get_stop_words(path = os.path.join(common_dir, "stopwords.txt")):
